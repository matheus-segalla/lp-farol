...
import './App.css'; // Garantir que o CSS personalizado está carregado

export default function FarolLP() {
  ...
  // Lógica para animação on-scroll
  useEffect(() => {
    const observer = new IntersectionObserver((entries) => {
      ...
      threshold: 0.2 // Elemento precisa estar 20% visível para trigar
    });
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans antialiased selection:bg-red-600 selection:text-white"
         style={{ backgroundImage: 'var(--bg-pattern)', backgroundAttachment: 'fixed', backgroundSize: 'cover' }}>
      
      {/* Top Banner */}
      <div className="bg-red-600/10 border-b border-red-500/20 py-2.5 px-4 text-center text-xs md:text-sm font-medium text-red-400 flex items-center justify-center gap-2 backdrop-blur-sm sticky top-0 z-50">
        <Flame className="w-4 h-4 text-red-500 animate-pulse" />
        <span>Oferta de lançamento: Valor promocional liberado por tempo limitado</span>
      </div>

      {/* Hero Section - Agora com fundo muted texturizado */}
      <section className="relative pt-12 pb-20 px-4 max-w-6xl mx-auto text-center border-b border-zinc-900/50"
               style={{ backgroundImage: 'linear-gradient(rgba(12, 10, 9, 0.7), rgba(12, 10, 9, 0.9)), url("https://images.unsplash.com/photo-1542282088-72c9c27ed0cd?auto=format&fit=crop&q=80&w=2000")', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
        
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-900/60 border border-zinc-800 text-xs font-semibold text-zinc-300 mb-6 backdrop-blur-sm animate-on-scroll">
          <Sparkles className="w-3.5 h-3.5 text-amber-500" />
          MÉTODO PRÁTICO GARAGEM ROUTE 66 - AVANCED LAB
        </div>

        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-white max-w-4xl mx-auto leading-tight animate-on-scroll">
          Aprenda a restaurar faróis com perfeição e lucre até <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-amber-500">R$ 350 por par</span> em 40 minutos.
        </h1>

        <p className="mt-6 text-base sm:text-lg text-zinc-400 max-w-2xl mx-auto leading-relaxed animate-on-scroll delay-100">
        ...
        {/* Comparativo Interativo Antes & Depois - Agora com animação suave */}
        <div className="mt-14 max-w-3xl mx-auto animate-on-scroll delay-300">
      ...
      {/* Métricas - Cards agora são transparentes (Glassmorphism) e animados */}
      <section className="py-16 bg-zinc-900/30 border-y border-zinc-900/50 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center max-w-xl mx-auto mb-10 animate-on-scroll">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-zinc-900/60 border border-zinc-800 p-6 rounded-2xl backdrop-blur-md animate-on-scroll delay-100">
            ...
            <div className="bg-zinc-900/60 border border-zinc-800 p-6 rounded-2xl backdrop-blur-md animate-on-scroll delay-200">
              ...
              <p className="text-3xl font-extrabold text-emerald-400 mt-1">R$ 250 a R$ 400</p>
              <p className="text-xs text-zinc-500 mt-2">Preço praticado no mercado para o par de faróis.</p>
            </div>

            <div className="bg-zinc-900/60 border border-zinc-800 p-6 rounded-2xl backdrop-blur-md animate-on-scroll delay-300">
      ...
      {/* Conteúdo - Passos animados na rolagem */}
      <section className="py-20 px-4 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            <div key={idx} className={`p-5 rounded-xl bg-zinc-900/60 border border-zinc-800 flex items-start gap-4 animate-on-scroll delay-${(idx % 2 === 0 ? 100 : 200)} backdrop-blur-sm`}>
      ...
      {/* Banner Presencial - Também Glassmorphism e animado */}
      <section className="px-4 max-w-5xl mx-auto mb-16 animate-on-scroll backdrop-blur-md">
        <div className="bg-gradient-to-r from-zinc-900/80 to-zinc-800/80 border border-zinc-700/60 p-8 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
      ...
      {/* Card Oferta Principal - Super Tech Look */}
      <section className="py-16 px-4 bg-zinc-900/40 border-t border-zinc-900/70 animate-on-scroll">
        <div className="max-w-md mx-auto bg-zinc-900 border-2 border-red-600 rounded-3xl p-8 text-center relative shadow-2xl backdrop-blur-lg"
             style={{ backgroundImage: 'linear-gradient(rgba(24, 24, 27, 0.9), rgba(24, 24, 27, 0.95)), url("https://images.unsplash.com/photo-1542282088-72c9c27ed0cd?auto=format&fit=crop&q=80&w=2000")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
          ...
          <p className="text-xs text-zinc-400 mt-1">Método Garagem Route 66 - Advanced Lab</p>
      ...
      {/* FAQ - Cards de Perguntas Transparentes */}
      <section className="py-16 px-4 max-w-3xl mx-auto animate-on-scroll delay-100">
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={i} className="border border-zinc-800 rounded-xl bg-zinc-900/60 overflow-hidden backdrop-blur-sm">
              <button 
                onClick={() => toggleFaq(i)}
      ...
      {/* Footer */}
      <footer className="py-8 border-t border-zinc-900/70 text-center text-xs text-zinc-600 bg-zinc-950/80 backdrop-blur-sm">
        <p>© 2026 Garagem Route 66 • Advanced Automotive Repair Labs</p>
      </footer>
    </div>
  );
}